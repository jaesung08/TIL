...
+ 삽입 및 삭제 위치
    * 선형큐 : rear = rear +1  // front = front +1 
    ...
    + ![사진3](pict3.png) ![사진4](pict4.png) ![사진5](pict5.png)
```py
def enQ(data):
    global rear
...
* ![Alt text](pict6.png) ![Alt text](pict7.png) ![Alt text](pict8.png) ![Alt text](pict9.png) ![Alt text](pict10.png) ![Alt text](pict11.png) ![Alt text](pict12.png) ![Alt text](pict13.png) ![Alt text](pict14.png) ![Alt text](pict15.png) ![Alt text](pict16.png)
```py
